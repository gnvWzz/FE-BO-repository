            ...
            <ThemeProvider theme={theme}>
              ...
              <Routes>
                ...
                <Route element={<Layout />}>
                  ...
                  <Route
                    exact
                    path="/store/product/:accountUsername"
                    element={<FirstForm />}
                  />
                  <Route
                    exact
                    path="/store/secondForm/:accountUsername"
                    element={<SecondForm />}
                  />
                  <Route
                    exact
                    path="/store/thirdForm/:accountUsername"
                    element={<ThirdForm />}
                  />
                  <Route
                    exact
                    path="/product/:accountUsername/:serialNumber"
                    element={<ProductInfo />}
                  />
                  <Route
                    exact
                    path="/product/edit/general/:accountUsername/:serialNumber"
                    element={<UpdateProductGeneralInfo />}
                  />
                  <Route
                    exact
                    path="/product/edit/detail/:accountUsername/:serialNumber"
                    element={<UpdateProductDetailInfo />}
                  />
                  <Route
                    exact
